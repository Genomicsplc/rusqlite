...
#[cfg(any(target_arch = "wasm32", feature = "loadable_extension", feature = "loadable_extension_embedded", feature = "non_threadsafe"))]
fn ensure_safe_sqlite_threading_mode() -> Result<()> {
    Ok(())
}

#[cfg(not(any(target_arch = "wasm32", feature = "loadable_extension", feature = "loadable_extension_embedded", feature= "non_threadsafe")))]
fn ensure_safe_sqlite_threading_mode() -> Result<()> {
