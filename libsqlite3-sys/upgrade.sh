...
function regenerate_bindgen_binding() {
    features=$1
    target_file=$2

    # remove existing target binding
    rm -f "${target_file}"
...
regenerate_bindgen_binding "buildtime_bindgen" "${SQLITE3_LIB_DIR}/bindgen_bundled_version.rs"
regenerate_bindgen_binding "buildtime_bindgen,loadable_extension" "${SQLITE3_LIB_DIR}/bindgen_bundled_version-ext.rs"
